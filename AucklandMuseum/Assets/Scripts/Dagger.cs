...
public class Dagger : MonoBehaviour {
    ...
    void Start () {
		...
		title.text = weapons[0].NameTitle;
		owner.text = owner.text + weapons [0].Keeper;
		dateUsed.text = dateUsed.text + weapons [0].LastModified;
	
		description.text = description.text + weapons [0].Description;
		category.text = category.text + weapons [0].Category;
		dimension.text = dimension.text + weapons [0].Dimesion;

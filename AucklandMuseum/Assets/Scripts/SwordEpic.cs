...
public class SwordEpic: MonoBehaviour {
    ...
    void Start () {
		...
		title.text = weapons[5].NameTitle;
		owner.text = owner.text + weapons [5].Keeper;
		dateUsed.text = dateUsed.text + weapons [5].LastModified;
	
		description.text = description.text + weapons [5].Description;
		category.text = category.text + weapons [5].Category;
		dimension.text = dimension.text + weapons [5].Dimesion;
